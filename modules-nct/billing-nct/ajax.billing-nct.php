...
if(isset($_GET['id']) && (int)$_GET['id'] > 0){
    ...
    $data['patient_name']       = $bill['patient_name'];
    $data['patient_phone']      = $bill['patient_phone'];
    $data['patient_gender']     = $bill['patient_gender'];
    $data['patient_dob']        = $bill['patient_dob'];
    $data['doctor_id']          = $bill['doctor_id'];
    $data['bill_date']          = $bill['bill_date'];
    $data['referred_doctor']    = $bill['referred_doctor'];
    $data['promo_code']         = $bill['promo_code'];

    /* SERVICES */
    $data['items'] = $db->pdoQuery("
...
if($_POST['action']=="generateBill"){
    ...
    $promo_code         = !empty($_POST['promo_code']) ? trim($_POST['promo_code']) : NULL;
    ...
    $db->pdoQuery("
        ...
        $db->pdoQuery("INSERT INTO tbl_bills (bill_number, clinic_id, appointment_id, patient_id, patient_name, patient_age, patient_gender, patient_phone, doctor_id, referred_doctor, promo_code, bill_date, patient_dob, subtotal, discount, total_amount)
        VALUES (
                '".$bill_number."',
                ".$clinic_id.",
