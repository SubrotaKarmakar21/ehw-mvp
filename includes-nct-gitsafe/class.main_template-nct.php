...
class MainTemplater {
    ...
    public function parse() {
         ...
         * Modified by ashish joshi - 
         * it can significantly faster if you add the 'S' study modifier:http://php.net/manual/en/reference.pcre.pattern.modifiers.php
         */
        ob_start();
        require $this -> template;
        $content = ob_get_clean();
        $content = preg_replace_callback('/\{([A-Za-z0-9_]+)\}/S', function($matches) {
